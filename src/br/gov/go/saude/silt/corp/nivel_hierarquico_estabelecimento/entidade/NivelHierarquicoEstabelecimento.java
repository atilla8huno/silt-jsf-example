package br.gov.go.saude.silt.corp.nivel_hierarquico_estabelecimento.entidade;
...
/**
 * Entidade que representa NivelHierarquicoEstabelecimento
 * 
 ...
 */
@Entity
@Table(name = "nivel_hierarquico_estabelecimento", schema = "corp")
public class NivelHierarquicoEstabelecimento extends Entidade implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NivelHierarquicoEstabelecimento other = (NivelHierarquicoEstabelecimento) obj;
		if (id == null) {
			if (other.id != null)
				return false;
